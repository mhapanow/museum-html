...
export class ZrstrecmService {
  ...
  getZrstrecmView01(token, meorg, melogo, mencct, meyfac, meaafc, mecifa, meagig): Observable<any> {
  ...
  getZrstrecmView02(token, meorg, melogo, mencct, meyfac, meaafc, mecifa, meagig): Observable<any> {
    ...
    // + meyfac + '&meaafc=' + meaafc + '&mecifa=' + mecifa + '&meagig=' + meagig);
  }
