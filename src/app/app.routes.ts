...
const app_routes: Routes = [
    ...
    { path: 'zrstdspsv3/:categoria', component: Zrstdspsview03Component },
    { path: 'zrstdspsv4/:ncuenta', component: Zrstdspsview04Component },
    { path: 'zrstdspsv5/:ncuenta', component: Zrstdspsview05Component },
    { path: 'zrstdspsv6/:ncuenta', component: Zrstdspsview06Component },
    ...
    { path: 'zrstrecmv1/:ncuenta', component: Zrstrecmview01Component },
    { path: 'zrstrecmv2/:ncuenta', component: Zrstrecmview02Component },
    { path: 'zrstreclv1/:ncuenta', component: Zrstreclview01Component },
    { path: 'zrstreclv2/:ncuenta', component: Zrstreclview02Component },
